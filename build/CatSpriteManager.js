"use strict";
var CatSpriteManager = (function () {
    function CatSpriteManager(game) {
        this.CAT_SPRITES = {
            "brown": {
    ...
    CatSpriteManager.prototype.loadSpritesForCat = function (catname) {
        var cat = this.CAT_SPRITES[catname];
        for (var key in cat) {
    ...
    return CatSpriteManager;
}());
exports.CatSpriteManager = CatSpriteManager;
